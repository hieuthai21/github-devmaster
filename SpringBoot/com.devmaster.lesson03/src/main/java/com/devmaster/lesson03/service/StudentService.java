...
public class StudentService {
    ...
    public StudentService() {
        students.addAll(
                Arrays.asList(
                    new Student(1L, "Devmaster Academy",20,"None","Số 25 Phố Vũ Ngọc Phan","0978611889","devmaster@gmail.com"),
                    new Student(2L,"Hiếu Thái",22, "Nam","Đại Linh","0123123123","hieuthai@gmail.com")
                )
        );
    }
